(function( $ ){
    $.fn.bootnumberspiner = function(options) {
        ...
        $(spinners).each(function (key,spinner) {
            ...
            spinner.settings.secId = $spinner.attr('second-id');
        ...
        function get_content(spinner){
            ...
            content += '<button type="button" class="btn btn-xs btn-danger btn-number" data-type="minus" data-field="'+spinner.settings.name+'['+spinner.settings.id+']" '+minDisabled+'>';
            content += '<span class="'+spinner.settings.minus_icon+'"></span>';
            content += '</button>';
            content += '</span>';
            content += '<input id="'+spinner.settings.secId+'" type="text" name="'+spinner.settings.name+'['+spinner.settings.id+']" class="form-control input-sm input-number" value="'+value+'" min="'+spinner.settings.min_value+'" max="'+spinner.settings.max_value+'">';
            content += '<span class="input-group-btn">';
            content += '<button type="button" class="btn btn-xs btn-success btn-number" data-type="plus" data-field="'+spinner.settings.name+'['+spinner.settings.id+']" '+maxDisabled+'>';
